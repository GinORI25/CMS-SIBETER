...
class Konten extends CI_Controller {
	...
	public function simpan()
	{
		...
		$this->db->where('judul',$this->input->post('judul'));
			$cek = $this->db->get()->result_array();
				if($cek<>NULL){
					$this->session->set_flashdata('alert','<div class="alert alert-danger">
					<i class="ti-face-sad"></i><strong>judul konten sudah ada</strong> </div>');
						redirect('admin/konten');
				}
				$data = array(
		...
		<i class="icofont icofont-check-circled"></i><strong> Konten Berhasil ditambahkan </strong>
	  </div>');
		redirect('admin/konten');
	}
	...
	public function delete($id)
	{
		...
		$this->session->set_flashdata('alert','<div class="alert alert-danger">
		<i class="icofont icofont-warning-alt"></i><strong> Konten Berhasil Dihapus</strong>
		</div>');
		redirect('admin/konten');
	}
	...
	public function update ()
	{
		...
		$this->session->set_flashdata('alert','<div class="alert alert-success">
		<i class="icofont icofont-check-circled"></i><strong> Konten Berhasil diperbarui </strong>
	  </div>');
		redirect('admin/konten');
	}
}
